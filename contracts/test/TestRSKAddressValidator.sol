...
contract TestRSKAddressValidator {
    ...
    function getAddress(bytes32 messageHash, bytes memory sig)
        public
        pure
        returns (address)
    {
    ...
    function compareAddressWithZeroPK(bytes32 messageHash, bytes memory sig)
        external
        view
        returns (bool)
    {
    ...
    function compareAddressWithSigner(
        bytes32 messageHash,
        bytes memory sig,
        address addr2
