...
import { changePartnerShares, ChangePartnerSharesArg, PartnerConfig } from '../../tasks/changePartnerShares';
  ...
  describe('changePartnerShares', function () {
    ...
    describe('', function () {
      ...
      it("should successfully call the 'updateShares' method with the partners and the default gas limit", async function () {
        ...
        expect(
          updateSharesSpy.calledWithExactly(parsedPartnerConfig.partners, {gasLimit: 150000})
        ).to.be.true;
      });
      ...
      it("should successfully call the 'updateShares' method with the partners and the gas limit", async function () {
        ...
        expect(
          updateSharesSpy.calledWithExactly(parsedPartnerConfig.partners, {gasLimit: allArgs.gasLimit})
        ).to.be.true;
      });
    })
