// TODO: These utils are mostly unnecessary in ethers, so when finishing the PR this file should be deleted. Keeping for now, in case some (rebased on master) bits are necessary
